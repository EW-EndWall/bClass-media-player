 ...
 */
     ...
     */
    // example..
    // videoPlayerList.length 1 fazla ise
    // ayarlarda değişiklik olunca şu fonksiyonu calıştır
    // function name(type, status) {
    //   switch (type) {
    //     case "speed":
    //       videoPlayerList.forEach((element) => {
    //         element.playbackRate = status;
    //       });
    //       break;
    //     case "volume":
    //       videoPlayerList.forEach((element) => {
...
$(document).ready(function () {
    if ($(".sound-player-container").length) {
      ...
      $(".sound-player-container").each(function () {
        ...
        const soundPlayerScreen = soundPlayerContainer.find(
          ".sound-player-screen"
        );
        ...
        const soundPlayerAlbum = soundPlayerContainer.find(
          ".sound-player-album"
        );
        const soundPlayerTitle = soundPlayerContainer.find(
          ".sound-player-title"
        );
        ...
        let soundPlayerSpeed =
          localStorage.getItem("sound-player-speed") || "1.0";
        ...
        soundPlayerVolumeBtn.on("input", function () {
          toggleSoundPlayerVolume($(this).val());
        });
        ...
        if (soundPlayerTimmer.length) {
          ...
          soundPlayerTimmer
            .on("mousemove", function (e) {
              ...
              const progressPercentage = clickX / progressBarWidth;
              const time = (
                soundElement.duration * progressPercentage
              ).toFixed(0);
              const newTime =
                time < 0
                  ? 0
              ...
              if (newTime != "NaN") {
                ...
                const w =
                  clickX < 0
                    ...
                    : clickX;
                const marginValue =
                  w - soundPlayerTimmerHover.innerWidth() / 2;
        ...
        // * Update timmer bar
        soundElement.addEventListener("timeupdate", function () {
        ...
        // * back forward
        soundPlayerBackBtn.on("click", function (e) {
          toggleSoundPlayerBackMedia();
        });
        // * fast forward
        soundPlayerForwardBtn.on("click", function (e) {
          toggleSoundPlayerForwardMedia();
        });
        // * auto play option
        soundPlayerAutoPlayBtn.on("click", function (e) {
          toggleSoundPlayerAutoPlay(!soundPlayerAutoPlay);
        });
        // * next play media
        soundPlayerNextPlayBtn.on("click", function (e) {
          toggleSoundPlayerNextPlay(!soundPlayerNextPlay);
        });
        ...
        function playerFormatTime(timeInSeconds) {
          const minutes = Math.floor(timeInSeconds / 60);
          const seconds = Math.floor(timeInSeconds % 60);
          return `${minutes}:${seconds.toString().padStart(2, "0")}`;
        }
        // * start playing the sound
        function toggleSoundPlayerPlayMedia() {
          // * is multiplay
          soundPlayerList.forEach(function (e) {
          ...
          soundElement.play();
          // * media speed add
          if (soundPlayerSpeed != 1)
            soundElement.playbackRate = soundPlayerSpeed;
          // * navigator info
        ...
        // * pause sound
        function toggleSoundPlayerPauseMedia() {
          // * changle play pause icon
          toggleSoundPlayerPlayPauseIcon();
          // * sound pause
          soundElement.pause();
        ...
        function toggleSoundPlayerNextMedia() {
        ...
        function toggleSoundPlayerPreviousMedia() {
        ...
        // * rewind
        function toggleSoundPlayerForwardMedia() {
          if (
        ...
        // * fast forward
        function toggleSoundPlayerBackMedia() {
        ...
        // * load sound
        function toggleSoundPlayerLoadMedia(index) {
          ...
          // * media info load
          function toggleSoundPlayerLoadMediaStart(sound) {
            ...
            soundElement.addEventListener("loadedmetadata", function () {
              // * Update times when new sound is uploaded
              toggleSoundPlayerCurrentTime(
                playerFormatTime(soundElement.currentTime)
              );
              toggleSoundPlayerTotalTime(
                playerFormatTime(soundElement.duration)
              );
            });
          }
        }
        // * navigator info create
        function toggleSoundPlayerMediaSessionNavigator(
          title,
          artist,
          album,
          poster
        ...
        function toggleSoundPlayerPlayPauseMedia() {
        ...
        function toggleSoundPlayerPlayPauseIcon() {
        ...
        // * sound player info
        function toggleSoundPlayerMedia(album, poster, title, artist) {
          ...
          if (poster)
            soundPlayerPoster.find("img").attr("src", poster[0].src);
        }
        // * sound timmer changle
        function toggleSoundPlayerTimmer(time) {
          if (soundPlayerTimmer.length) {
        ...
        function toggleSoundPlayerVolume(vol) {
        ...
        function toggleSoundPlayerShuffle(status) {
        ...
        // * sound repeat option
        function toggleSoundPlayerRepeat(status) {
        ...
        function toggleSoundPlayerAutoPlay(status) {
        ...
        function toggleSoundPlayerNextPlay(status) {
        ...
        // * media speed option
        function toggleSoundPlayerSpeed(status) {
          const text = soundPlayerSpeedBtn
            .find("span")
            .filter(function () {
              return $(this).attr("value") === status;
            })
            .text();
        ...
        function toggleSoundPlayerSubTitle(status) {
          ...
          if (status != "close") {
            const lag = soundPlayerSubTitleTrack.filter(function () {
        ...
        // * guality create func
        function toggleSoundPlayerQualityAppend() {
          if (sounds.length) {
        ...
        // * media quality option
        function toggleSoundPlayerQuality(status) {
          if (sounds.length) {
...
$(document).ready(function () {
    if ($(".video-player-container").length) {
      ...
      $(".video-player-container").each(function () {
        ...
        const videoPlayerAlbum = videoPlayerContainer.find(
          ".video-player-album"
        );
        const videoPlayerTitle = videoPlayerContainer.find(
          ".video-player-title"
        );
        ...
        let videoPlayerSpeed =
          localStorage.getItem("video-player-speed") || "1.0";
        ...
        videoPlayerVolumeBtn.on("input", function () {
          toggleVideoPlayerVolume($(this).val());
        });
        // * Trigger when shuffle button is clicked
        videoPlayerShuffleBtn.on("click", function () {
          toggleVideoPlayerShuffle(!videoPlayerShuffle);
          // * If shuffle is enabled and repeat is also enabled, disable repeat
        ...
        // * Trigger on clicking play again
        videoPlayerRepeatBtn.on("click", function () {
          toggleVideoPlayerRepeat(!videoPlayerRepeat);
          // * If repeat is enabled and shuffle is also enabled, disable shuffle
        ...
        if (videoPlayerTimmer.length) {
          videoPlayerTimmer.on("click", function (e) {
            const progressBarRect = this.getBoundingClientRect();
            const clickX = e.clientX - progressBarRect.left;
            const progressBarWidth = progressBarRect.width;
            const progressPercentage = clickX / progressBarWidth;
          ...
          videoPlayerTimmer
            .on("mousemove", function (e) {
              ...
              const progressPercentage = clickX / progressBarWidth;
              const time = (
                videoElement.duration * progressPercentage
              ).toFixed(0);
              const newTime =
                time < 0
                  ? 0
              ...
              if (newTime != "NaN") {
                ...
                const w =
                  clickX < 0
                    ...
                    : clickX;
                const marginValue =
                  w - videoPlayerTimmerHover.innerWidth() / 2;
        ...
        if (videoPlayerHoverLoadBtn.length && videoPlayerHoverLoad) {
          ...
          videoPlayerHoverLoadBtn.on("mouseover", () => {
        ...
        // * back forward
        videoPlayerBackBtn.on("click", function (e) {
          toggleVideoPlayerBackMedia();
        });
        // * fast forward
        videoPlayerForwardBtn.on("click", function (e) {
          toggleVideoPlayerForwardMedia();
        });
        // * auto play option
        videoPlayerAutoPlayBtn.on("click", function (e) {
          toggleVideoPlayerAutoPlay(!videoPlayerAutoPlay);
        });
        // * next play media
        ...
        // * cinema mode options
        videoPlayerCinemaBtn.on("click", function (e) {
          toggleVideoPlayerCinema($(this));
        });
        // * media description mode option
        videoPlayerDescriptionsBtn.on("click", function (e) {
          toggleVideoPlayerDescriptions(!videoPlayerDescriptions);
        });
        // * media play speed option
        ...
        videoPlayerFullScreenBtn.on("click", function (e) {
          toggleVideoPlayerFullScreen($(this));
        });
        // * Function to format time in minutes and seconds
        function playerFormatTime(timeInSeconds) {
          const minutes = Math.floor(timeInSeconds / 60);
        ...
        function toggleVideoPlayerPlayMedia() {
          // * is multiplay
          videoPlayerList.forEach(function (e) {
            if (!e.hasAttribute("multiplay")) e.pause();
          });
          // * changle play pause icon
          toggleVideoPlayerPlayPauseIcon();
          ...
          videoElement.play();
          // * media speed add
          if (videoPlayerSpeed != 1)
            videoElement.playbackRate = videoPlayerSpeed;
          // * navigator info
        ...
        // * pause video
        function toggleVideoPlayerPauseMedia() {
          // * changle play pause icon
          toggleVideoPlayerPlayPauseIcon();
          // * video pause
          videoElement.pause();
        ...
        function toggleVideoPlayerNextMedia() {
        ...
        function toggleVideoPlayerPreviousMedia() {
        ...
        // * rewind
        function toggleVideoPlayerForwardMedia() {
          if (
        ...
        // * fast forward
        function toggleVideoPlayerBackMedia() {
        ...
        // * load video
        function toggleVideoPlayerLoadMedia(index) {
          ...
          // * media info load
          function toggleVideoPlayerLoadMediaStart(video) {
            ...
            videoElement.addEventListener("loadedmetadata", function () {
              ...
              toggleVideoPlayerTotalTime(
                playerFormatTime(videoElement.duration)
              );
            });
          }
        }
        // * navigator info create
        function toggleVideoPlayerMediaSessionNavigator(
          title,
          artist,
          album,
          poster
        ...
        function toggleVideoPlayerPlayPauseMedia() {
        ...
        function toggleVideoPlayerPlayPauseIcon() {
        ...
        // * video player info
        function toggleVideoPlayerMedia(album, poster, title, artist) {
        ...
        function toggleVideoPlayerTimmer(time) {
          if (videoPlayerTimmer.length) {
        ...
        function toggleVideoPlayerVolume(vol) {
        ...
        function toggleVideoPlayerShuffle(status) {
        ...
        // * video repeat option
        function toggleVideoPlayerRepeat(status) {
        ...
        // * media autoplay option
        function toggleVideoPlayerAutoPlay(status) {
        ...
        // * media nextplay option
        function toggleVideoPlayerNextPlay(status) {
        ...
        function toggleVideoPlayerDescriptions(status) {
        ...
        // * media subtitle option
        function toggleVideoPlayerSubTitle(status) {
          ...
          if (status != "close") {
            const lag = videoPlayerSubTitleTrack.filter(function () {
              return $(this).attr("srclang") === status;
            });
            if (lag.length) {
              // open subtitle
        ...
        // * guality create func
        function toggleVideoPlayerQualityAppend() {
          if (videos.length) {
        ...
        // * media quality option
        function toggleVideoPlayerQuality(status) {
          if (videos.length) {
            ...
            videoPlayerQualityText.text(
              status != "auto" ? status + "p" : status
            );
        ...
        // * media cinema option
        function toggleVideoPlayerCinema(element) {
        ...
        function toggleVideoPlayerFullScreen(element) {
          if (
